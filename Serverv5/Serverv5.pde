...
char line_buf[70];                        // Used to store line of http reply header
...
/*
  ...
  {  
    ...
    if(String(vv).startsWith(String(line_buf)))
    {
      found = true;
      Serial.print("==========================found:    ");Serial.print(value);Serial.print("   compares:  ");Serial.println(line_buf);
      bfill.emit_p(PSTR("{\"sensorId\":\"$S\""), vv);
      ...
      bfill.emit_p(PSTR(",\"vendor\":\"HOC\",\"name\":\"$S\"}"), "sensor");
      break;
    }   
  }
